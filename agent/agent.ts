 ...
 * comes from its registry row; `modelForPlan` maps it to a direct Anthropic
 * `LanguageModel` (via `ANTHROPIC_API_KEY`), or `null` to fall back to the
 * compiled default. Fully data-driven — no per-tenant code.
 */
