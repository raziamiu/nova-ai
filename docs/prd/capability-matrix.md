...
| 09–15 (v2) | Blueprint v2: one phase per Master Build PRD Stage 3–9 (Proof → Craft → Conversation → Reach → Presence → Team → Launch) | ⬜ planned | [blueprint v2](../blueprint/README.md) · [nova-ui-build-01](./capabilities/nova-ui-build-01-ledger-feed.md) |
